...
descr = "cp gateware.bin /media/devel/5221-0000/vga-pong-PipelineC.bin" 
print(descr)
descr = "Loads the iCE40UP5K with vga-pong-PipelineC.bin"
print(descr)
...
file = open("vga-pong-PipelineC.bin","br")
fpga.start()
#fpga.cram(file)
